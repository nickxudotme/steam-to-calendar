...
export const UI_COPY = {
  en: {
    ...
    connectWishlistDescription: 'Auto-sync releases, discounts, and preorders from your public wishlist.',
    manualGamesTitle: 'Manual list',
    manualGamesDescription: 'Search and maintain a few tracked games yourself.',
    trackedGamesSetupDescription: 'Connect a wishlist, or keep a manual list.',
  ...
  zh: {
    ...
    connectWishlistDescription: '从公开愿望单自动同步发售、折扣和预购。',
    manualGamesTitle: '手动列表',
    manualGamesDescription: '自己搜索并维护少量关注游戏。',
    trackedGamesSetupDescription: '关联愿望单，或维护手动列表。',
    recommendedLabel: '推荐',
    includedLabel: '已包含',
    excludedLabel: '关闭',
    orLabel: '或',
