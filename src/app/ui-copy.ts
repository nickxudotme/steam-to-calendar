...
export const UI_COPY = {
  en: {
    ...
    connectWishlistTitle: 'Connect your Steam wishlist',
    connectWishlistDescription: 'Recommended: automatically sync wishlist releases, discounts, and preorders.',
    manualGamesTitle: 'Or add games manually',
    manualGamesDescription: 'Try the calendar with a few games before connecting your Steam profile.',
  ...
  zh: {
    ...
    calendarReadyTitle: '你的日历已准备好',
    connectWishlistTitle: '关联 Steam 愿望单',
    connectWishlistDescription: '推荐：自动同步愿望单里的发售、折扣和预购。',
    manualGamesTitle: '也可以手动添加游戏',
    manualGamesDescription: '先用几个游戏试试看，之后再关联 Steam 个人资料。',
    recommendedLabel: '推荐',
